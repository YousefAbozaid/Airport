...
### Key Features
*   **Modern UI:** Clean design with a dark mode aesthetic and gold accents (`var(--bg-dark)`, `var(--bg-card)`, `var(--accent)`).
*   **Interactive Elements:** Hover animations on cards, buttons, and table rows to provide a responsive feel.
*   **Flight Dashboard:** Dynamic counters, interactive status filters (All, On Time, Delayed, Boarding), and a real-time flight table.
...
├── style.css         # All styling, variables, layout, and animations
├── script.js         # Interactivity (counters, filters, search)
...
If you are a team member, locate your section in `index.html` and add your code between the designated tags!

### Section Assignments:
1.  **Navigation & Hero:** Implemented
2.  **Schedule:** `<section id="schedule">` *(Team Member 2)*
3.  **Book Ticket:** `<section id="book">` *(Team Member 3)*
4.  **Dashboard:** Implemented
5.  **Baggage:** Implemented
